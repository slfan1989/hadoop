...
public class ILoadTestS3ABulkDeleteThrottling extends S3AScaleTestBase {
  ...
  public void test_010_Reset(final boolean throttle,
      final int pageSize, final int requests) throws Throwable {
    initILoadTestS3ABulkDeleteThrottling(throttle, pageSize, requests);
    testWasThrottled = false;
  }

  @MethodSource("params")
  @ParameterizedTest(name = "bulk-delete-aws-retry={0}-requests={2}-size={1}")
  public void test_020_DeleteThrottling(final boolean throttle,
      final int pageSize, final int requests) throws Throwable {
    initILoadTestS3ABulkDeleteThrottling(throttle, pageSize, requests);
  ...
  @MethodSource("params")
  @ParameterizedTest(name = "bulk-delete-aws-retry={0}-requests={2}-size={1}")
  public void test_030_Sleep(final boolean throttle,
      final int pageSize, final int requests) throws Throwable {
    initILoadTestS3ABulkDeleteThrottling(throttle, pageSize, requests);
    maybeSleep();
  }
