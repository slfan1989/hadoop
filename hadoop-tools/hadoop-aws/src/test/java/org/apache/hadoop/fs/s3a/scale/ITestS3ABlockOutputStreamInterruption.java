...
public class ITestS3ABlockOutputStreamInterruption extends S3AScaleTestBase {
   ...
   */
  public void initITestS3ABlockOutputStreamInterruption(final String bufferType,
      int activeBlocks) throws Exception {
  ...
  public void testInterruptMultipart(String bufferType,
      int activeBlocks) throws Throwable {
    initITestS3ABlockOutputStreamInterruption(bufferType, activeBlocks);
  ...
  @MethodSource("params")
  @ParameterizedTest(name = "{0}-{1}")
  public void testAbortDuringUpload(String bufferType,
      int activeBlocks) throws Throwable {
    initITestS3ABlockOutputStreamInterruption(bufferType, activeBlocks);
  ...
  @MethodSource("params")
  @ParameterizedTest(name = "{0}-{1}")
  public void testPartUploadFailure(String bufferType,
      int activeBlocks) throws Throwable {
    initITestS3ABlockOutputStreamInterruption(bufferType, activeBlocks);
  ...
  @MethodSource("params")
  @ParameterizedTest(name = "{0}-{1}")
  public void testInterruptMagicWrite(String bufferType,
      int activeBlocks) throws Throwable {
    initITestS3ABlockOutputStreamInterruption(bufferType, activeBlocks);
  ...
  @MethodSource("params")
  @ParameterizedTest(name = "{0}-{1}")
  public void testInterruptWhenAbortingAnUpload(String bufferType,
      int activeBlocks) throws Throwable {
    initITestS3ABlockOutputStreamInterruption(bufferType, activeBlocks);
    describe("Interrupt a thread performing close() on a magic upload");
  ...
  @MethodSource("params")
  @ParameterizedTest(name = "{0}-{1}")
  public void testInterruptSimplePut(String bufferType,
      int activeBlocks) throws Throwable {
    initITestS3ABlockOutputStreamInterruption(bufferType, activeBlocks);
